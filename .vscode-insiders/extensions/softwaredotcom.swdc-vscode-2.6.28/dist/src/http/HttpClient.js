...
exports.isResponseOk = exports.hasTokenExpired = exports.softwareDelete = exports.softwarePost = exports.softwareGet = exports.appDelete = exports.appPost = exports.appPut = exports.appGet = void 0;
...
const headers = {
    ...
    'X-SWDC-Plugin-Editor': (0, Util_1.getEditorName)(),
 ...
 */
function softwarePost(api, payload, jwt = null) {
    return __awaiter(this, void 0, void 0, function* () {
        updateOutgoingHeader();
        return beApi
            .post(api, payload)
            ...
            .catch((err) => {
            (0, Util_1.logIt)(`error posting data for ${api}, message: ${err.message}`);
            return err;
        });
    });
}
...
function softwareDelete(api, jwt) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return beApi
            ...
            .catch((err) => {
            (0, Util_1.logIt)(`error with delete request for ${api}, message: ${err.message}`);
            return err;
        });
    });
}
