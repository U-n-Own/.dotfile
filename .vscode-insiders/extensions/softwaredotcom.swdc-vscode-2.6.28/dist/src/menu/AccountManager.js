...
function createAnonymousUser() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!jwt) {
            ...
            const resp = yield (0, HttpClient_1.softwarePost)('/plugins/onboard', {
                timezone,
                username,
                plugin_uuid,
                hostname,
            ...
            if ((0, HttpClient_1.isResponseOk)(resp) && resp.data && resp.data.jwt) {
                (0, Util_1.setItem)('jwt', resp.data.jwt);
