...
module.exports = function () {
    ...
    if (activeTextEditor && activeTextEditor.document.languageId === "vso") {
        ...
        //messages
        let fullDateMessage = new showMessage_1.WindowMessage('warning', "Full date must be entered", false, false);
        let notADateMessage = new showMessage_1.WindowMessage('warning', "That's not a valid date. ", false, false);
                ...
                vscode.window
                    ...
                    if (year !== undefined && day !== undefined && month !== undefined) {
                        ...
                        if (dateFormat === "MM-DD-YYYY") {
                            workspaceEdit.insert(document.uri, current_line.range.start, current_line.text + "    SCHEDULED: [" + month + "-" + day + "-" + year + "]");
                        }
                        else if (dateFormat === "DD-MM-YYYY") {
                            workspaceEdit.insert(document.uri, current_line.range.start, current_line.text + "    SCHEDULED: [" + day + "-" + month + "-" + year + "]");
                        }
