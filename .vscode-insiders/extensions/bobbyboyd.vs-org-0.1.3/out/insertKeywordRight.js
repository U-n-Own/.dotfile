    ...
    if (activeTextEditor && activeTextEditor.document.languageId === "vso") {
        ...
        if (current_line.text.includes(unicode_char)) {
            if (current_line.text.includes("DONE")) {
                ...
                //need to append file
                workspaceEdit.delete(document.uri, current_line.range);
                workspaceEdit.insert(document.uri, current_line.range.start, line_leading_spaces + unicode_char + "DONE " + text_without_todo + "    COMPLETED:" + "[" + date + "]");
                return vscode.workspace.applyEdit(workspaceEdit);
            }
        }
    }
...
//# sourceMappingURL=insertKeywordRight.js.map